...
#if 0
student_t* 
search_student_by_roll_no(dll_t *student_db,
...
main(int argc, char **argv){
    ...
    //student_t* student = search_student_by_roll_no(student_db, 20190518);
    student_t* student = dll_search_by_key(student_db, (void*)20190518);
    if(!student){
